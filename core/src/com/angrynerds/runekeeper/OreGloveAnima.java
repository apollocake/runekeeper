...
public class OreGloveAnima {
    ...
    private void createAnimations() {
        ...
        attackingSheet = new Texture(Gdx.files.internal("OreGlove.png"));
        ...
        //index = 0;
        rightIdling = new Animation(0.075f, attackingRightFrames);
