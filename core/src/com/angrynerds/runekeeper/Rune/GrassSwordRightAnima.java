 ...
 * @author qzhao
 */
public class GrassSwordRightAnima {
    ...
    private void createAnimations() {
        ...
        attackingSheet = new Texture(Gdx.files.internal("GrassSwordRight.png"));
    ...
    public void showFireAnimation(SpriteBatch spriteBatch, int x, int y){
        ...
        spriteBatch.draw(currentFrame, x, y, Gdx.graphics.getWidth() / 12, Gdx.graphics.getHeight() / 10);             // #17
    }
}
